...
def main(
    ...
    files = ['49_heart_c', '55_hepatitis', '455_cars', '42_soybean', '31_credit_g', '1100_popularkids', '511_plasma_retinol', '1470_dresses_sales', '454_analcatdata_halloffame', '488_colleges_aaup', '451_irish', 'zip-county-fips', '1_anneal', '13_breast_cancer']
    ...
    for dat_path in dataset_paths:
        ...
        metadata[dat_path] = trial_kwargs['dataset'].metadata
    ...
    for row in rows:
        ...
        if meta['deviation_percentage'] > 1.0:
            print("Low certainty")
        else:
